          ...
          <form className="space-y-3" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              {loading ? (
                ...
                <button
                  type="submit"
                  className="inline-block mt-5 w-full cursor-pointer rounded bg-orange-500 px-6 py-3 text-white font-semibold shadow-md transition duration-300 ease-in-out hover:bg-orange-600 hover:scale-105"
                >
                  Sign Up
                </button>
              )}
